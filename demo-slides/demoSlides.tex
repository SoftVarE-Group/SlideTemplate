...
\begin{frame}{Create new Boxes}
	...
	\begin{definition}{This is a Definition}
		With \texttt{\textbackslash MakeNewBox\{name\}\{color\}} you can change the color of a box (locally to the current group). This definition was changed with \texttt{\textbackslash UpdateBoxColor\{definition\}\{teal\}}.
	\end{definition}}
	\begin{definition}{Another Definition}
		This definition appears outside of the group with \texttt{\textbackslash UpdateBoxColor\{definition\}\{teal\}} active.
	\end{definition}
\end{frame}
