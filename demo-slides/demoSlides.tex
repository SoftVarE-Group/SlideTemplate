\documentclass[
	...
	%nosectiontitleslides, % disable automatic section title slide and section overview at the begin of each section
	%sectiontitleslides, % enable an automatic section title slide at the begin of each section
	sectionoverviews, % enable an automatic section overview at the begin of each section (enabled by default)
